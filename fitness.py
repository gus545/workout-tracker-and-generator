...
def main():
    """
    Main function to initialize the Notion client and perform operations.
    """
    ...
    # Create an instance of FitnessManager
    fitness_manager = FitnessManager(notion_client)

    # Update the 1RMs for big lifts
    fitness_manager.update_big_lift_1RMs()
